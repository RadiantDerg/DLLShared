...
struct MemoryEditor
{
    ...
    void DrawPreviewLine(const Sizes& s, void* mem_data_void, size_t mem_size, size_t base_display_addr)
    {
        ...
        ImGui::Combo("##combo_endianess", &PreviewEndianess, "Little\0Big\0\0");
        ...
        if (has_value)
            DrawPreviewData(DataPreviewAddr, mem_data, mem_size, ImGuiDataType_Float, DataFormat_Dec, buf, (size_t)IM_ARRAYSIZE(buf));
        ImGui::Text("Flt"); ImGui::SameLine(x); ImGui::TextUnformatted(has_value ? buf : "N/A");
        if (has_value)
    ...
    void DrawValueEditor(const Sizes& s, void* mem_data_void, size_t mem_size, size_t base_display_addr)
    {
